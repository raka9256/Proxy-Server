...
import com.ps.config.DefaultProfileUtil;
...
public class ProxyServerApp {
    ...
    public ProxyServerApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes proxy_server.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ProxyServerApp.class);
